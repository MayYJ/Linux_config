...
pre_install(){
    ...
    shadowsockspwd="mei"
    echo "Your password is mei"
    # Set ShadowsocksR config port
    shadowsocksport=2222
    echo "Your port is 2222"
    # Set shadowsocksR config stream ciphers
    shadowsockscipher=${ciphers[1]}
    echo "your ciphers is aes-256-cfb"
    # Set shadowsocksR config protocol
    shadowsockprotocol=${protocols[5]}
    echo "Your protocol is auth_aes128_sha1"

    shadowsockobfs=${obfs[5]}
    echo "Your obfs is tls1.2_ticket_auth"
